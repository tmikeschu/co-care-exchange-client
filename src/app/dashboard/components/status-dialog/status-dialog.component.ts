...
export class StatusDialogComponent {
  message: string;
  sharemessage = 'Are you able to pick up {0} from {1}?';
  needmessage = 'You matched as a sharer for {0} {1} of {2}.  Can you drop the items off at this location?  ';
  confirmmessage = 'Did you pickup {0} from {1}? ';
  okButtonText = 'OK';
  showNoButton = false;
  showMap = false;
